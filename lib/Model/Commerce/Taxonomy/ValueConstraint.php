...
class ValueConstraint implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->container['applicable_for_localized_aspect_name'] = $data['applicable_for_localized_aspect_name'] ?? null;
        $this->container['applicable_for_localized_aspect_values'] = $data['applicable_for_localized_aspect_values'] ?? null;
    }
     ...
     *
     * @param string|null $applicable_for_localized_aspect_name The name of the control aspect on which the current aspect value depends.
     *
     * @return self
     */
     ...
     *
     * @param string[]|null $applicable_for_localized_aspect_values Contains a list of the values of the control aspect on which this aspect's value depends. When the control aspect has any of the specified values, the current value of the current aspect will also be available.
     *
     * @return self
     */
