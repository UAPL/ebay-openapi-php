...
class AncestorReference implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets category_id
     *
     * @param string|null $category_id The unique identifier of the eBay ancestor category. Note: The root node of a full default category tree includes the categoryId field, but its value should not be relied upon. It provides no useful information for application development.
     *
     * @return self
     */
     ...
     * Sets category_name
     *
     * @param string|null $category_name The name of the ancestor category identified by categoryId.
     *
     * @return self
     */
     ...
     *
     * @param string|null $category_subtree_node_href The href portion of the getCategorySubtree call that retrieves the subtree below the ancestor category node.
     *
     * @return self
     */
     ...
     *
     * @param int|null $category_tree_node_level The absolute level of the ancestor category node in the hierarchy of its category tree. Note: The root node of any full category tree is always at level 0.
     *
     * @return self
     */
