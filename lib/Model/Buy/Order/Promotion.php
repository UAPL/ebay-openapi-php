...
class Promotion implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets message
     *
     * @param string|null $message The text for the promotion title, which describes the promotion.
     *
     * @return self
     */
     ...
     * Sets promotion_type
     *
     * @param string|null $promotion_type The kind of promotion. Some examples are: <code>SellerDiscountedPromotionalOffer</code> and <code>COUPON</code>.
     *
     * @return self
     */
