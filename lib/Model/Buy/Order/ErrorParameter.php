...
class ErrorParameter implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets name
     *
     * @param string|null $name The name of the input field that caused an issue with the method request.
     *
     * @return self
     */
     ...
     * Sets value
     *
     * @param string|null $value The actual value that was passed in for the element specified in the <b>name</b> field.
     *
     * @return self
     */
