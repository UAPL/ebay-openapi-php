...
class Amount implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets currency
     *
     * @param string|null $currency The currency used in the monetary transaction. Generally, this is the currency used by the country of the eBay site offering the item. For implementation help, refer to <a href='https://developer.ebay.com/api-docs/buy/order/types/bas:CurrencyCodeEnum'>eBay API documentation</a>
     *
     * @return self
     */
     ...
     * Sets value
     *
     * @param string|null $value The amount of the currency specified in the <b>currency</b> field. The value of the <b>currency</b> defaults to the standard currency used by the country of the eBay site offering the item.
     *
     * @return self
     */
