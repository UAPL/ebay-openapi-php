...
class Recipient implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets first_name
     *
     * @param string|null $first_name The first name of the person receiving the purchase order.
     *
     * @return self
     */
     ...
     * Sets last_name
     *
     * @param string|null $last_name The last name of the person receiving the purchase order.
     *
     * @return self
     */
