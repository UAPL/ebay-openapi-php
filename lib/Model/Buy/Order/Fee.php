...
class Fee implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets fee_type
     *
     * @param string|null $fee_type The type of fee associated with the line item. For implementation help, refer to <a href='https://developer.ebay.com/api-docs/buy/order/types/gct:FeeEnum'>eBay API documentation</a>
     *
     * @return self
     */
