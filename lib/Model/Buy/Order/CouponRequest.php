 ...
 */
class CouponRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CouponRequest';
     ...
     *
     * @param string|null $redemption_code The redemption code of the coupon.<br /><br /><b>Maximum:</b> One redemption code per order
     *
     * @return self
     */
