...
class Amount implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets currency
     *
     * @param string|null $currency The three-letter ISO 4217 code representing the currency of the amount in the value field. Default: The currency of the authenticated user's country. For implementation help, refer to <a href='https://developer.ebay.com/api-docs/buy/deal/types/bas:CurrencyCodeEnum'>eBay API documentation</a>
     *
     * @return self
     */
     ...
     * Sets value
     *
     * @param string|null $value The monetary value, in the currency specified by the currency field.
     *
     * @return self
     */
