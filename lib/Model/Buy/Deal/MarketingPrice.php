...
class MarketingPrice implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     *
     * @param string|null $discount_percentage The percentage of the seller discount based on the value returned in the originalPrice field.
     *
     * @return self
     */
     ...
     *
     * @param string|null $price_treatment The pricing treatment (discount) that was applied to the price of the item. Note: The pricing treatment affects how and where the discounted price can be displayed. For implementation help, refer to <a href='https://developer.ebay.com/api-docs/buy/deal/types/api:PriceTreatmentEnum'>eBay API documentation</a>
     *
     * @return self
     */
