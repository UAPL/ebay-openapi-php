...
/**
 * DealItemSearchResponse Class Doc Comment
 *
 * @category Class
...
class DealItemSearchResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DealItemSearchResponse';
    ...
    {
        $this->container['deal_items'] = $data['deal_items'] ?? null;
    ...
    {
        return $this->container['deal_items'];
    }
     ...
     * @return self
     */
    public function setDealItems($deal_items)
    {
        $this->container['deal_items'] = $deal_items;
