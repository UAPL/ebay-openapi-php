...
/**
 * ItemPriorityResponse Class Doc Comment
 *
 * @category Class
 * @package  Ebay
 * @author   OpenAPI Generator team
 ...
 */
class ItemPriorityResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ItemPriorityResponse';
    ...
    {
        $this->container['item_delta'] = $data['item_delta'] ?? null;
    }
    ...
    {
        return $this->container['item_delta'];
    }
     ...
     * @return self
     */
    public function setItemDelta($item_delta)
    {
        $this->container['item_delta'] = $item_delta;
