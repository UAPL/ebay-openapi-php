...
class Category implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets category_id
     *
     * @param string|null $category_id The unique identifier of the primary item category of the item, as well as the secondary item category if item was listed in two categories.
     *
     * @return self
     */
