...
class BuyingOptionDistribution implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets buying_option
     *
     * @param string|null $buying_option The container that returns the buying option type. This will be AUCTION or FIXED_PRICE or both. For details, see <a href=\"/api-docs/buy/browse/resources/item_summary/methods/search#response.itemSummaries.buyingOptions\">buyingOptions</a>.
     *
     * @return self
     */
