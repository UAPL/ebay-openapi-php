...
class ItemPriorityApi
{
    ...
    {
        list($response) = $this->getItemPriorityFeedWithHttpInfo($accept, $x_ebay_c_marketplace_id, $range, $category_id, $date);
        return $response;
    }
    ...
    public function getItemPriorityFeedRequest($accept, $x_ebay_c_marketplace_id, $range, $category_id, $date)
    {
        ...
        if ($accept === null || (is_array($accept) && count($accept) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $accept when calling getItemPriorityFeed'
            );
        }
        // verify the required parameter 'x_ebay_c_marketplace_id' is set
        if ($x_ebay_c_marketplace_id === null || (is_array($x_ebay_c_marketplace_id) && count($x_ebay_c_marketplace_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $x_ebay_c_marketplace_id when calling getItemPriorityFeed'
            );
        }
        // verify the required parameter 'range' is set
        if ($range === null || (is_array($range) && count($range) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $range when calling getItemPriorityFeed'
            );
        }
        // verify the required parameter 'category_id' is set
        if ($category_id === null || (is_array($category_id) && count($category_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $category_id when calling getItemPriorityFeed'
            );
        }
        // verify the required parameter 'date' is set
        if ($date === null || (is_array($date) && count($date) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $date when calling getItemPriorityFeed'
            );
        }
