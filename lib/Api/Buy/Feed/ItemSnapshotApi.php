...
class ItemSnapshotApi
{
    ...
    {
        list($response) = $this->getItemSnapshotFeedWithHttpInfo($accept, $x_ebay_c_marketplace_id, $range, $category_id, $snapshot_date);
        return $response;
    }
    ...
    public function getItemSnapshotFeedRequest($accept, $x_ebay_c_marketplace_id, $range, $category_id, $snapshot_date)
    {
        ...
        if ($accept === null || (is_array($accept) && count($accept) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $accept when calling getItemSnapshotFeed'
            );
        }
        ...
        if ($snapshot_date !== null) {
            if('form' === 'form' && is_array($snapshot_date)) {
                foreach($snapshot_date as $key => $value) {
                    $queryParams[$key] = $value;
                }
            }
            else {
                $queryParams['snapshot_date'] = $snapshot_date;
            }
        }
