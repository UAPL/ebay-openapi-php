...
class GuestCheckoutSessionApi
{
     ...
     * @param  \Ebay\Ebay\Model\Buy\Order\CouponRequest $coupon_request The container for the fields used to apply a coupon to a guest checkout session. (optional)
     *
     * @throws \Ebay\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Ebay\Ebay\Model\Buy\Order\GuestCheckoutSessionResponseV2
     */
    public function applyGuestCoupon($checkout_session_id, $x_ebay_c_marketplace_id, $coupon_request = null)
    {
        list($response) = $this->applyGuestCouponWithHttpInfo($checkout_session_id, $x_ebay_c_marketplace_id, $coupon_request);
        return $response;
    }
     ...
     * @throws \Ebay\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Ebay\Ebay\Model\Buy\Order\GuestCheckoutSessionResponseV2, HTTP status code, HTTP response headers (array of strings)
     */
    public function applyGuestCouponWithHttpInfo($checkout_session_id, $x_ebay_c_marketplace_id, $coupon_request = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Ebay\Ebay\Model\Buy\Order\GuestCheckoutSessionResponseV2' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Ebay\Ebay\Model\Buy\Order\GuestCheckoutSessionResponseV2', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\Ebay\Ebay\Model\Buy\Order\GuestCheckoutSessionResponseV2';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Ebay\Ebay\Model\Buy\Order\GuestCheckoutSessionResponseV2',
    ...
    public function applyGuestCouponRequest($checkout_session_id, $x_ebay_c_marketplace_id, $coupon_request = null)
    {
        ...
        if ($checkout_session_id === null || (is_array($checkout_session_id) && count($checkout_session_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $checkout_session_id when calling applyGuestCoupon'
            );
        }
        // verify the required parameter 'x_ebay_c_marketplace_id' is set
        if ($x_ebay_c_marketplace_id === null || (is_array($x_ebay_c_marketplace_id) && count($x_ebay_c_marketplace_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $x_ebay_c_marketplace_id when calling applyGuestCoupon'
            );
        }
    ...
    {
        list($response) = $this->getGuestCheckoutSessionWithHttpInfo($checkout_session_id, $x_ebay_c_marketplace_id);
        return $response;
    }
    ...
    public function getGuestCheckoutSessionRequest($checkout_session_id, $x_ebay_c_marketplace_id)
    {
        ...
        if ($checkout_session_id === null || (is_array($checkout_session_id) && count($checkout_session_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $checkout_session_id when calling getGuestCheckoutSession'
            );
        }
        // verify the required parameter 'x_ebay_c_marketplace_id' is set
        if ($x_ebay_c_marketplace_id === null || (is_array($x_ebay_c_marketplace_id) && count($x_ebay_c_marketplace_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $x_ebay_c_marketplace_id when calling getGuestCheckoutSession'
            );
        }
     ...
     * @param  \Ebay\Ebay\Model\Buy\Order\CreateGuestCheckoutSessionRequestV2 $create_guest_checkout_session_request_v2 The container for the fields used by the &lt;b&gt;initiateGuestCheckoutSession&lt;/b&gt; method. (optional)
     *
     * @throws \Ebay\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Ebay\Ebay\Model\Buy\Order\GuestCheckoutSessionResponseV2
    ...
    {
        list($response) = $this->initiateGuestCheckoutSessionWithHttpInfo($x_ebay_c_marketplace_id, $x_ebay_c_enduserctx, $create_guest_checkout_session_request_v2);
        return $response;
    }
    ...
    public function initiateGuestCheckoutSessionRequest($x_ebay_c_marketplace_id, $x_ebay_c_enduserctx = null, $create_guest_checkout_session_request_v2 = null)
    {
        ...
        if ($x_ebay_c_marketplace_id === null || (is_array($x_ebay_c_marketplace_id) && count($x_ebay_c_marketplace_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $x_ebay_c_marketplace_id when calling initiateGuestCheckoutSession'
            );
        }
     ...
     * @param  string $checkout_session_id The eBay-assigned session ID, for a specific eBay marketplace, that is returned by the &lt;b&gt; initiateGuestCheckoutSession&lt;/b&gt; method.&lt;br /&gt;&lt;br /&gt;&lt;span class&#x3D;\&quot;tablenote\&quot;&gt;&lt;b&gt;Note:&lt;/b&gt; When using this ID, the X-EBAY-C-MARKETPLACE-ID value and developer App ID must be the same as that used when this guest checkout session was created. See &lt;a href&#x3D;\&quot;/api-docs/buy/order/overview.html#checkout-restriction\&quot;&gt;Checkout session restrictions&lt;/a&gt; in the Buy Integration Guide for details.&lt;/span&gt; (required)
     * @param  string $x_ebay_c_marketplace_id A header that identifies the user&#39;s business context and is specified using a marketplace ID value.&lt;br /&gt;&lt;br /&gt;&lt;span class&#x3D;\&quot;tablenote\&quot;&gt;&lt;b&gt;Note:&lt;/b&gt; This header does &lt;i&gt;not&lt;/i&gt; indicate a language preference or consumer location.&lt;/span&gt;&lt;br /&gt;&lt;br /&gt;See &lt;a href&#x3D;\&quot;/api-docs/static/rest-request-components.html#marketpl\&quot; target&#x3D;\&quot;_blank\&quot;&gt;Marketplace ID values&lt;/a&gt; for a list of supported values. (required)
     * @param  \Ebay\Ebay\Model\Buy\Order\CouponRequest $coupon_request The container for the fields used by the &lt;b&gt;removeGuestCoupon&lt;/b&gt; method. (optional)
     *
     * @throws \Ebay\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Ebay\Ebay\Model\Buy\Order\GuestCheckoutSessionResponseV2
    ...
    {
        list($response) = $this->removeGuestCouponWithHttpInfo($checkout_session_id, $x_ebay_c_marketplace_id, $coupon_request);
        return $response;
    }
    ...
    public function removeGuestCouponRequest($checkout_session_id, $x_ebay_c_marketplace_id, $coupon_request = null)
    {
        ...
        if ($checkout_session_id === null || (is_array($checkout_session_id) && count($checkout_session_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $checkout_session_id when calling removeGuestCoupon'
            );
        }
        // verify the required parameter 'x_ebay_c_marketplace_id' is set
        if ($x_ebay_c_marketplace_id === null || (is_array($x_ebay_c_marketplace_id) && count($x_ebay_c_marketplace_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $x_ebay_c_marketplace_id when calling removeGuestCoupon'
            );
        }
     ...
     * @param  string $checkout_session_id The eBay-assigned session ID, for a specific eBay marketplace, that is returned by the &lt;b&gt; initiateGuestCheckoutSession&lt;/b&gt; method.&lt;br /&gt;&lt;br /&gt;&lt;span class&#x3D;\&quot;tablenote\&quot;&gt;&lt;b&gt;Note:&lt;/b&gt; When using this ID, the X-EBAY-C-MARKETPLACE-ID value and developer App ID must be the same as that used when this guest checkout session was created. See &lt;a href&#x3D;\&quot;/api-docs/buy/order/overview.html#checkout-restriction\&quot;&gt;Checkout session restrictions&lt;/a&gt; in the Buy Integration Guide for details.&lt;/span&gt; (required)
     * @param  string $x_ebay_c_marketplace_id A header that identifies the user&#39;s business context and is specified using a marketplace ID value.&lt;br /&gt;&lt;br /&gt;&lt;span class&#x3D;\&quot;tablenote\&quot;&gt;&lt;b&gt;Note:&lt;/b&gt; This header does &lt;i&gt;not&lt;/i&gt; indicate a language preference or consumer location.&lt;/span&gt;&lt;br /&gt;&lt;br /&gt;See &lt;a href&#x3D;\&quot;/api-docs/static/rest-request-components.html#marketpl\&quot; target&#x3D;\&quot;_blank\&quot;&gt;Marketplace ID values&lt;/a&gt; for a list of supported values. (required)
     * @param  \Ebay\Ebay\Model\Buy\Order\UpdateQuantity $update_quantity The container for the fields used by the &lt;b&gt;updateGuestQuantity&lt;/b&gt; method. (optional)
     *
     * @throws \Ebay\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Ebay\Ebay\Model\Buy\Order\GuestCheckoutSessionResponseV2
    ...
    {
        list($response) = $this->updateGuestQuantityWithHttpInfo($checkout_session_id, $x_ebay_c_marketplace_id, $update_quantity);
        return $response;
    }
    ...
    public function updateGuestQuantityRequest($checkout_session_id, $x_ebay_c_marketplace_id, $update_quantity = null)
    {
        ...
        if ($checkout_session_id === null || (is_array($checkout_session_id) && count($checkout_session_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $checkout_session_id when calling updateGuestQuantity'
            );
        }
        // verify the required parameter 'x_ebay_c_marketplace_id' is set
        if ($x_ebay_c_marketplace_id === null || (is_array($x_ebay_c_marketplace_id) && count($x_ebay_c_marketplace_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $x_ebay_c_marketplace_id when calling updateGuestQuantity'
            );
        }
     ...
     * @param  string $checkout_session_id The eBay-assigned session ID, for a specific eBay marketplace, that is returned by the &lt;b&gt; initiateGuestCheckoutSession&lt;/b&gt; method.&lt;br /&gt;&lt;br /&gt;&lt;span class&#x3D;\&quot;tablenote\&quot;&gt;&lt;b&gt;Note:&lt;/b&gt; When using this ID, the X-EBAY-C-MARKETPLACE-ID value and developer App ID must be the same as that used when this guest checkout session was created. See &lt;a href&#x3D;\&quot;/api-docs/buy/order/overview.html#checkout-restriction\&quot;&gt;Checkout session restrictions&lt;/a&gt; in the Buy Integration Guide for details.&lt;/span&gt; (required)
     * @param  string $x_ebay_c_marketplace_id A header that identifies the user&#39;s business context and is specified using a marketplace ID value.&lt;br /&gt;&lt;br /&gt;&lt;span class&#x3D;\&quot;tablenote\&quot;&gt;&lt;b&gt;Note:&lt;/b&gt; This header does &lt;i&gt;not&lt;/i&gt; indicate a language preference or consumer location.&lt;/span&gt;&lt;br /&gt;&lt;br /&gt;See &lt;a href&#x3D;\&quot;/api-docs/static/rest-request-components.html#marketpl\&quot; target&#x3D;\&quot;_blank\&quot;&gt;Marketplace ID values&lt;/a&gt; for a list of supported values. (required)
     * @param  \Ebay\Ebay\Model\Buy\Order\ShippingAddressImpl $shipping_address_impl The container for the fields used by the &lt;b&gt;updateGuestShippingAddress&lt;/b&gt; method. (optional)
     *
     * @throws \Ebay\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Ebay\Ebay\Model\Buy\Order\GuestCheckoutSessionResponseV2
    ...
    {
        list($response) = $this->updateGuestShippingAddressWithHttpInfo($checkout_session_id, $x_ebay_c_marketplace_id, $shipping_address_impl);
        return $response;
    }
    ...
    public function updateGuestShippingAddressRequest($checkout_session_id, $x_ebay_c_marketplace_id, $shipping_address_impl = null)
    {
        ...
        if ($checkout_session_id === null || (is_array($checkout_session_id) && count($checkout_session_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $checkout_session_id when calling updateGuestShippingAddress'
            );
        }
        // verify the required parameter 'x_ebay_c_marketplace_id' is set
        if ($x_ebay_c_marketplace_id === null || (is_array($x_ebay_c_marketplace_id) && count($x_ebay_c_marketplace_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $x_ebay_c_marketplace_id when calling updateGuestShippingAddress'
            );
        }
     ...
     * @param  string $checkout_session_id The eBay-assigned session ID, for a specific eBay marketplace, that is returned by the &lt;b&gt; initiateGuestCheckoutSession&lt;/b&gt; method.&lt;br /&gt;&lt;br /&gt;&lt;span class&#x3D;\&quot;tablenote\&quot;&gt;&lt;b&gt;Note:&lt;/b&gt; When using this ID, the X-EBAY-C-MARKETPLACE-ID value and developer App ID must be the same as that used when this guest checkout session was created. See &lt;a href&#x3D;\&quot;/api-docs/buy/order/overview.html#checkout-restriction\&quot;&gt;Checkout session restrictions&lt;/a&gt; in the Buy Integration Guide for details.&lt;/span&gt; (required)
     * @param  string $x_ebay_c_marketplace_id A header that identifies the user&#39;s business context and is specified using a marketplace ID value.&lt;br /&gt;&lt;br /&gt;&lt;span class&#x3D;\&quot;tablenote\&quot;&gt;&lt;b&gt;Note:&lt;/b&gt; This header does &lt;i&gt;not&lt;/i&gt; indicate a language preference or consumer location.&lt;/span&gt;&lt;br /&gt;&lt;br /&gt;See &lt;a href&#x3D;\&quot;/api-docs/static/rest-request-components.html#marketpl\&quot; target&#x3D;\&quot;_blank\&quot;&gt;Marketplace ID values&lt;/a&gt; for a list of supported values. (required)
     * @param  \Ebay\Ebay\Model\Buy\Order\UpdateShippingOption $update_shipping_option The container for the fields used by the &lt;b&gt;updateGuestShippingOption&lt;/b&gt; method. (optional)
     *
     * @throws \Ebay\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Ebay\Ebay\Model\Buy\Order\GuestCheckoutSessionResponseV2
    ...
    {
        list($response) = $this->updateGuestShippingOptionWithHttpInfo($checkout_session_id, $x_ebay_c_marketplace_id, $update_shipping_option);
        return $response;
    }
    ...
    public function updateGuestShippingOptionRequest($checkout_session_id, $x_ebay_c_marketplace_id, $update_shipping_option = null)
    {
        ...
        if ($checkout_session_id === null || (is_array($checkout_session_id) && count($checkout_session_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $checkout_session_id when calling updateGuestShippingOption'
            );
        }
        // verify the required parameter 'x_ebay_c_marketplace_id' is set
        if ($x_ebay_c_marketplace_id === null || (is_array($x_ebay_c_marketplace_id) && count($x_ebay_c_marketplace_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $x_ebay_c_marketplace_id when calling updateGuestShippingOption'
            );
        }
