...
class EventItemApi
{
    ...
    {
        list($response) = $this->getEventItemsWithHttpInfo($event_ids, $x_ebay_c_marketplace_id, $category_ids, $delivery_country, $limit, $offset);
        return $response;
    }
    ...
    public function getEventItemsRequest($event_ids, $x_ebay_c_marketplace_id, $category_ids = null, $delivery_country = null, $limit = null, $offset = null)
    {
        ...
        if ($event_ids === null || (is_array($event_ids) && count($event_ids) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $event_ids when calling getEventItems'
            );
        }
        // verify the required parameter 'x_ebay_c_marketplace_id' is set
        if ($x_ebay_c_marketplace_id === null || (is_array($x_ebay_c_marketplace_id) && count($x_ebay_c_marketplace_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $x_ebay_c_marketplace_id when calling getEventItems'
            );
        }
        ...
        // query params
        if ($event_ids !== null) {
            if('form' === 'form' && is_array($event_ids)) {
                foreach($event_ids as $key => $value) {
                    $queryParams[$key] = $value;
                }
            }
            else {
                $queryParams['event_ids'] = $event_ids;
            }
        }
        // query params
        if ($limit !== null) {
